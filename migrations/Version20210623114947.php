 ...
 */
final class Version20210623114947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trip ADD user_id INT NOT NULL, ADD photo_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trip DROP user_id, DROP photo_id');
    }
}
